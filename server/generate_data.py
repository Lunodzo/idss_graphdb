...
clients = []
for i in range(1, 500001): # Adjust the number of clients here
    clients.append({
        "kind": "Client",
        "key": i,
        "name": fake.name(),
...
consumptions = []
for i in range(1, 2000001): # Adjust the number of consumption records here
    consumptions.append({
        "kind": "Consumption",
        "key": i,
...
for client in clients:
    consumption_keys = random.sample(range(1, 2000000), 3)  
